...
func (v Vector) DotR(v2 Vector) ComponentType {
	return v.DotYZX(v2)
}

func (v Vector) DotYZX(v2 Vector) ComponentType {
	return v.y*v2.x + v.z*v2.y + v.x*v2.z
}

func (v Vector) DotRR(v2 Vector) ComponentType {
	return v.DotZXY(v2)
}

func (v Vector) DotZXY(v2 Vector) ComponentType {
	return v.z*v2.x + v.x*v2.y + v.y*v2.z

}
func (v Vector) DotYXZ(v2 Vector) ComponentType {
	return v.y*v2.x + v.x*v2.y + v.z*v2.z
}

func (v Vector) DotZYX(v2 Vector) ComponentType {
	return v.z*v2.x + v.y*v2.y + v.x*v2.z
}

func (v Vector) DotXZY(v2 Vector) ComponentType {
