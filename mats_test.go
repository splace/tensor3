...
func TestMatsPrint(t *testing.T) {
	ms := Matrices{Matrix{*New(1, 2, 3), *New(4, 5, 6), *New(7, 8, 9)}}
...
func TestMatsProduct1(t *testing.T) {
	ms := Matrices{Matrix{*New(1, 2, 3), *New(4, 5, 6), *New(7, 8, 9)}}
	ms.Product(Matrix{*New(9, 8, 7), *New(6, 5, 4), *New(3, 2, 1)})
...
func TestMatsSum(t *testing.T) {
	ms := Matrices{Matrix{*New(1, 2, 3), *New(4, 5, 6), *New(7, 8, 9)}, Matrix{*New(1, 2, 3), *New(4, 5, 6), *New(7, 8, 9)}, Matrix{*New(1, 2, 3), *New(4, 5, 6), *New(7, 8, 9)}}
...
func TestMatsApplyComponents(t *testing.T) {
	ms := Matrices{Matrix{*New(1, 2, 3), *New(4, 5, 6), *New(7, 8, 9)}}
	ms.AggregateComponentWise(*New(1, 2, 3), (*Vector).Add)
...
func TestMatsApplyComponentY(t *testing.T) {
	ms := Matrices{Matrix{*New(1, 2, 3), *New(4, 5, 6), *New(7, 8, 9)}}
	ms.ApplyComponentWiseVariac(*New(1, 2, 3), nil, (*Vector).Subtract)
...
func TestMatsApplyComponentsXY(t *testing.T) {
	ms := Matrices{Matrix{*New(1, 2, 3), *New(4, 5, 6), *New(7, 8, 9)}}
	ms.ApplyComponentWiseVariac(*New(1, 2, 3), (*Vector).Add, (*Vector).Subtract)
...
func BenchmarkMatsProduct(b *testing.B) {
	...
	for i := range ms {
		ms[i] = Matrix{*New(1, 2, 3), *New(4, 5, 6), *New(7, 8, 9)}
	}
