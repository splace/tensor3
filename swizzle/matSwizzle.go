...
func (m *Matrix) MultiplyR(s float64) {
	m.MultiplyYZX(s)
}

func (m *Matrix) MultiplyYZX(s float64) {
	m.y.Multiply(s)
	m.z.Multiply(s)
	m.x.Multiply(s)
}

func (m *Matrix) MultiplyRR(s float64) {
	m.MultiplyZXY(s)
}

func (m *Matrix) MultiplyZXY(s float64) {
	m.z.Multiply(s)
	m.x.Multiply(s)
	m.y.Multiply(s)
}

func (m *Matrix) MultiplyYXZ(s float64) {
	m.y.Multiply(s)
	m.x.Multiply(s)
	m.z.Multiply(s)
}
func (m *Matrix) MultiplyZYX(s float64) {
	m.z.Multiply(s)
	m.y.Multiply(s)
	m.x.Multiply(s)
}
func (m *Matrix) MultiplyXZY(s float64) {
	m.x.Multiply(s)
	m.z.Multiply(s)
	m.y.Multiply(s)
}
